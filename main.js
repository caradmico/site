...
const planetsData = [
  { name: 'mercury', distance: 0.387, radius: 0.5, texturePath: './textures/2k_mercury.jpg', initialAngle: Math.atan2(-0.39360647687959077, -0.15617905102240556) },
  { name: 'venus', distance: 0.723, radius: 1, texturePath: './textures/2k_venus_surface.jpg', initialAngle: Math.atan2(0.0038495805009816936, 0.7252778270399232) },
  { name: 'earth', distance: 1.0, radius: 1.2, texturePath: './textures/2k_earth_daymap.jpg', initialAngle: Math.atan2(-0.8787777356810902, 0.3404893717576449) },
  { name: 'mars', distance: 1.524, radius: 0.8, texturePath: './textures/2k_mars.jpg', initialAngle: Math.atan2(-0.3810775835484354, -1.5794890330124596) },
  { name: 'jupiter', distance: 5.203, radius: 3, texturePath: './textures/2k_jupiter.jpg', initialAngle: Math.atan2(4.714503915866097, -0.402812960921938) },
  { name: 'saturn', distance: 9.537, radius: 2.5, texturePath: './textures/2k_saturn.jpg', initialAngle: Math.atan2(-0.5010083118219353, 9.538669032672617) },
...
const speedup = 525960; // Approx factor to make Earth orbit in ~60 real seconds (1 year / 60s)
